...
for i in range(len(rows)):
    added_list.append(column_list2[i] + column_list[i])

added_list = np.array(added_list)

added_list = np.array_split(added_list, len(test_matrix[0]))
print(np.array(added_list))
